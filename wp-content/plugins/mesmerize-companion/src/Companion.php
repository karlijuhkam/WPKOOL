...
class Companion
{
    ...
    public function __construct($root = null)
    {
        ...
        // magic check for current theme in customize.php
        if ($previewedTheme = $this->checkForThemePreviewdInCustomizer()) {
            $this->themeSlug = $previewedTheme;
        }
    ...
    public function checkForThemePreviewdInCustomizer()
    {
        ...
        if($themeData->get('Template')){
            $textDomain  = $themeData->get('Template');
        }

        $textDomain = apply_filters('cloudpress\customizer\previewed_theme', $textDomain );
